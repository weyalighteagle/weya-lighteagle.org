...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://rdvtoohclywlpbbnfbdd.supabase.co");
...
async function GET(request) {
    ...
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("weya_voicechat_kb").select("content").eq("persona_id", personaId).single();
...
async function POST(request) {
    try {
        ...
        // Upsert to Supabase
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("weya_voicechat_kb").upsert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__98876576._.js.map